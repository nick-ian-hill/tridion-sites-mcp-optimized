...
export const batchDeleteItemsById = {
    ...
    description: `Starts an asynchronous process to permanently delete a batch of items from the Content Manager.
    This is more efficient than deleting items individually.
    If an item cannot be deleted (e.g., it is used by another item), it will be skipped, but the batch process will continue for the remaining items.`,
    input: {
