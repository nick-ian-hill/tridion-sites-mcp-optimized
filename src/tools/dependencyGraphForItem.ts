...
`,
    input: {
        ...
        includeProperties: z.array(z.string()).optional().describe(`The PREFERRED method for retrieving specific details. Provide an array of property names to include in the response and use dot notation for nested properties (e.g., ['ComponentType', 'BluePrintInfo.IsLocalized', 'Schema.IdRef', 'VersionInfo.CheckOutUser.IdRef']). If used, the 'details' parameter is ignored. The base properties 'Id', 'Title', and '$type' will always be included.`),
    },
