...
export const getSchemaLinks = {
    name: "getSchemaLinks",
    description: "Gets a list of all Schema links within a Publication, filtered by purpose. This tool is useful for finding the available schemas when creating an item or changing an item's metadata schema. For example, use it to find a 'Component' schema before calling 'createItem', a 'Region' schema before calling 'createSchema', or a 'Metadata' schema before calling 'updateItemProperties'.",
    input: {
