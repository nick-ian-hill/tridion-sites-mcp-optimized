...
- Category -> Must be in a Publication (tcm:0-x-1).`),
    ...
    relatedKeywords: z.array(z.string().regex(/^(tcm:\d+-\d+-1024|ecl:[^:\s]+)$/)).optional().describe("An array of URIs for related Keywords. Use 'getItemsInContainer' or 'getClassificationKeywordsForCategory' to find keywords."),
