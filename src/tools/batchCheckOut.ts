...
export const batchCheckOut = {
    name: "batchCheckOut",
    description: `Starts an asynchronous process to check out a batch of versioned items, creating new, editable versions. This action locks each item for the current user, preventing others from editing them.`,
    input: {
