...
This tool is useful for reporting and for understanding the complete historical dependencies of an item, which is different from 'dependencyGraphForItem' (which checks only the *current* state).
