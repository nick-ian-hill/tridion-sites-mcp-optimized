...
export const SearchQueryValidation = z.object({
  ...
  ])).optional().describe("An array of item types to limit the search results to. If asked to search for a 'Bundle' or 'SearchFolder', use the 'VirtualFolder' type and then review the '$type' property of any returned items."),
