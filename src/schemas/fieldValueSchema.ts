...
export const singleLineTextFieldSchema = z.object({
    ...
    MaxOccurs: z.number().int().default(1).describe("The maximum number of times the field can occur (e.g., 1 for single-value, -1 for unlimited multi-value). Typically set to 1 for title, subtitle, heading, and headline type fields."),
    IsIndexable: z.boolean().default(true).describe("Whether the field value is included when performing a search. IMPORTANT: Can only be true if IsPublishable is also true."),
    IsLocalizable: z.boolean().optional().describe("Whether the field value can be changed in localized items."),
    IsPublishable: z.boolean().default(true).describe("Whether the field value is included when publishing."),
...
export const keywordFieldSchema = z.object({
    ...
    Description: z.string().nonempty().describe("A human-readable description of the field's purpose. This field is required."),
    MinOccurs: z.number().int().optional().describe("The minimum number of times the field can occur (e.g., 0 for optional, 1 for mandatory)."),
    MaxOccurs: z.number().int().default(-1).describe("The maximum number of times the field can occur (e.g., 1 for single-value, -1 for unlimited multi-value). Typically set to -1 for classification fields."),
    IsIndexable: z.boolean().default(true).describe("Whether the field value is included when performing a search. IMPORTANT: Can only be true if IsPublishable is also true."),
    IsLocalizable: z.boolean().optional().describe("Whether the field value can be changed in localized items."),
    IsPublishable: z.boolean().default(true).describe("Whether the field value is included when publishing."),
